    ...
    <section id="oto" class="container mt-3">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-4">
                        <h3 class="text-info">Kết quả tìm thấy</h3>
                    </div>
                    <div class="col-md-8">
                        <div class="dropdown float-right">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item {{Request::get('orderby') == 'macdinh' ? "active" : ""}}" href="{{ request()->fullUrlWithQuery(['orderby' => 'macdinh']) }}">Mặc định</a>
                                <a class="dropdown-item {{Request::get('orderby') == 'desc' ? "active" : ""}}" href="{{ request()->fullUrlWithQuery(['orderby' => 'desc']) }}">Mới nhất</a>
                                <a class="dropdown-item {{Request::get('orderby') == 'price_asc' ? "active" : ""}}" href="{{ request()->fullUrlWithQuery(['orderby' => 'price_asc']) }}">Giá tăng dần</a>
                                <a class="dropdown-item {{Request::get('orderby') == 'price_desc' ? "active" : ""}}" href="{{ request()->fullUrlWithQuery(['orderby' => 'price_desc']) }}">Giá giảm dần</a>
                            </div>
                        </div>
