...
<head>
    ...
    <link rel="stylesheet" href="/backend/jquery.fancybox.min.css">
    ...
    <script src="/backend/hightchart/highcharts.js"></script>
    <script src="/backend/hightchart/modules/data.js"></script>
    <script src="/backend/hightchart/modules/drilldown.js"></script>
    <script src="/backend/hightchart/modules/exporting.js"></script>
    <script src="/backend/hightchart/modules/export-data.js"></script>
    <script src="/backend/hightchart/modules/accessibility.js"></script>
...
<div class="wrapper">
    ...
    <aside class="control-sidebar control-sidebar-dark" style="display: none;">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href="/backend/#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
            <li><a href="/backend/#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div class="tab-pane" id="control-sidebar-home-tab">
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="/backend/javascript:void(0)">
            ...
            <div class="tab-pane" id="control-sidebar-settings-tab">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label class="control-sidebar-subheading">
                            Delete chat history
                            <a href="/backend/javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                        </label>
                    </div>
                    <!-- /.form-group -->
                </form>
...
<script src="/backend/js.js"></script>
<script src="/backend/jquery.fancybox.min.js"></script>
