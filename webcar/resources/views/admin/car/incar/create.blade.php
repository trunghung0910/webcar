...
@section('content')
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            <form action="{{route('quantri.incar.store',[$car_id])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Mời Bạn Nhập Tên Nội thất" value="{{old('name')}}">
                            @if($errors->has('name'))
